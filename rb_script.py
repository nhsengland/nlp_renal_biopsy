...
# Example usage:
# Ollama: python rb_script.py --backend ollama --root_dir src/renal_biopsy
# --model_name phi3.5:3.8b-mini-instruct-q4_K_M
# --n_shots 2 --n_prototype 1 --include_guidelines
# Ollama (diff model): python rb_script.py --backend ollama --root_dir src/renal_biopsy
# --model_name qwen2.5:1.5b-instruct-fp16 --n_shots 2
# --n_prototype 1 --include_guidelines
# LlamaCpp: python rb_script.py --backend llamacpp --root_dir
# src/renal_biopsy --model_name models/Phi-3.5-mini-instruct-Q5_K_M.gguf
# --n_shots 2 --n_prototype 1 --include_guidelines

if __name__ == "__main__":
    print(
        "Ensure you have annotated some examples in the Streamlit app, \
        saved it, and use that file here."
    )
    ...
    required_files = {
        ...
        "annotated_reports": root_dir / "data" / args.annotated_reports,
    }
    ...
    try:
        ...
        model_class = (
            RenalBiopsyOllamaQA if args.backend == "ollama" else RenalBiopsyLlamaCppQA
        )
    ...
    try:
        ...
        all_scores, score_per_report, final_score = model.evaluate(
            annotated_json, predicted_json, n_prototypes=args.n_prototype
        )
